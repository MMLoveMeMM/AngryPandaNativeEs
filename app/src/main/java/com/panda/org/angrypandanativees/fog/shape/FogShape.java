package com.panda.org.angrypandanativees.fog.shape;
...
public class FogShape extends AbstractVertexTexture {
    ...
    public FogShape(Context context) {
    ...
    public void initShader() {
        ...
        String vertex_src = ShaderParse.loadFromAssetsFile("fog_triangle_vertex.glsl", context.getResources());//
        String frag_src = ShaderParse.loadFromAssetsFile("fog_triangle_frag.glsl", context.getResources());//
