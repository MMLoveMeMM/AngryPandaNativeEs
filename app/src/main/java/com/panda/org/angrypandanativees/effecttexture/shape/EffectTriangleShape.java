package com.panda.org.angrypandanativees.effecttexture.shape;
...
public class EffectTriangleShape extends AbstractVertexTexture {
    ...
    public EffectTriangleShape(Context context) {
    ...
    public void initShader() {
        ...
        String vertex_src = ShaderParse.loadFromAssetsFile("effect_triangle_vertex.glsl", context.getResources());//
        String frag_src = ShaderParse.loadFromAssetsFile("effect_triangle_frag.glsl", context.getResources());//
