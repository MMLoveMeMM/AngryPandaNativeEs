...
void TriangleTexture::initVertex()
{
}

void TriangleTexture::initShader(const char * vertexShaderCode, const char* fragmentShaderCode)
{
...
void TriangleTexture::initTexture()
{
...
void TriangleTexture::draw(float mvpMatrix[])
{
